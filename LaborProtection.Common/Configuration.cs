namespace LaborProtection.Common
{
    ...
    {
        public const string DEFAULT_CONNECTION = "Data Source=localhost;Database=LaborProtectionDb;Trusted_Connection=True;Encrypt=false";
        public const string STATIC_FOLDER = "Images/";
    }
